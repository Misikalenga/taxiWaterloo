...
@section('content')
    ...
    <section id="accueil" class ="bg-gray-950 text-white">
        ...
        <div class="relative py-60 bg-cover bg-center bg-fixed" style="background-image: url('{{ asset('image/waterloo.png') }}');">
            <div class="absolute inset-0 bg-black/10"></div>
                ...
                <div class="relative z-10  max-w-5xl mx-auto text-center px-4 text-white">
                    ...
                    <div class="mt-10">
                        <a href="{{ route('reservation') }}" class="group hover:outline outline-2 outline-gray-950 -outline-offset-1 relative inline-flex items-center justify-center px-4 py-2 bg-taxi text-black hover:text-taxi font-bold transition-all overflow-hidden rounded-xl shadow-2xl active:scale-95 md:w-auto">
        ...
        <div class="max-w-6xl mx-auto px-6 relative z-10 text-center">
            ...
            <div class="grid grid-cols-2 md:grid-cols-3 gap-4 md:gap-8 mb-24 px-4">
                <div class="p-6 bg-white border border-gray-100 rounded-3xl shadow-sm hover:shadow-xl transition-all hover:-translate-y-2 group">
                    ...
                    <h4 class="font-bold text-gray-900 text-md uppercase tracking-widest mb-2">Multilingue</h4>
                    <p class="pt-4 text-md text-gray-500 leading-relaxed border-t border-gray-50 mt-4">
                ...
                <div class="p-6 bg-white border border-gray-100 rounded-3xl shadow-sm hover:shadow-xl transition-all hover:-translate-y-2 group">
                    ...
                    <h4 class="font-bold text-gray-900 text-md uppercase tracking-widest mb-2">Ponctualité</h4>
                    <p class="pt-4 text-md text-gray-500 leading-relaxed border-t border-gray-50 mt-4">
                ...
                <div class="p-6 bg-white border border-gray-100 rounded-3xl shadow-sm hover:shadow-xl transition-all hover:-translate-y-2 group">
                    ...
                    <h4 class="font-bold text-gray-900 text-md uppercase tracking-widest mb-2">Prix Fixes</h4>
                    <p class="pt-4 text-md text-gray-500 leading-relaxed border-t border-gray-50 mt-4">
                ...
                <div class="p-6 bg-white border border-gray-100 rounded-3xl shadow-sm hover:shadow-xl transition-all hover:-translate-y-2 group md:col-span-2">
                    ...
                    <h4 class="font-bold text-gray-900 text-md uppercase tracking-widest mb-2">Standing</h4>
                    <p class="pt-4 text-md text-gray-500 leading-relaxed border-t border-gray-50 mt-4">
                ...
                <div class="p-6 bg-white border border-gray-100 rounded-3xl shadow-sm hover:shadow-xl transition-all hover:-translate-y-2 group col-span-2 md:col-span-1">
                    ...
                    <h4 class="font-bold text-gray-900 text-md uppercase tracking-widest mb-2">Dispo 24/7</h4>
                    <p class="pt-4 text-md text-gray-500 leading-relaxed border-t border-gray-50 mt-4">
            ...
            <div class="pt-16 flex flex-col  gap-8 justify-center items-center">
                <a href="{{ route('reservation') }}" class="group hover:outline outline-2 outline-taxi -outline-offset-1 hover:text-black relative inline-flex items-center justify-center px-12 py-4 bg-gray-950 text-white font-bold transition-all overflow-hidden rounded-xl shadow-2xl active:scale-95 w-full md:w-auto">
                    <span class="relative z-10 uppercase tracking-[0.2em] text-md">Réserver mon trajet</span>
        ...
        <div class="max-w-6xl mx-auto px-6 relative z-10 pt-16 md:pt-32 pb-24">
            <div class="grid grid-cols-1 lg:grid-cols-2 gap-16 md:gap-24 relative">
                ...
                <div class="relative group">
                    <div class="absolute -top-10 -left-6 text-8xl font-black text-white/[0.02] select-none pointer-events-none group-hover:text-taxi/10  transition-all duration-300 ">01</div>
                    <div class="space-y-8 relative z-10">
                        ...
                        <div class="space-y-6 text-gray-400 group-hover:text-gray-300 transition-all duration-300  leading-relaxed text-sm md:text-base">
                ...
                <div class="relative group">
                    <div class="absolute -top-10 -left-6 text-8xl font-black text-white/[0.02] select-none pointer-events-none group-hover:text-taxi/10  transition-all duration-300 ">02</div>
                    <div class="space-y-8 relative z-10">
                        <h3 class="text-white text-xl md:text-2xl font-bold uppercase tracking-wide border-b border-taxi/30 pb-6 leading-tight">
